...
- **Activité en superposition** : notifications et messagerie s'ouvrent dans un panneau latéral à droite, sans quitter la page courante ; le badge rouge des messages se met à jour automatiquement sur desktop et mobile, et les URL complètes restent disponibles en repli sans JavaScript
